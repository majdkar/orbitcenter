...
public class AcceptedCompaniesFilterSpecification : HeroSpecification<Company>
{
    public AcceptedCompaniesFilterSpecification( GetAcceptedCompaniesQuery request)
    {
