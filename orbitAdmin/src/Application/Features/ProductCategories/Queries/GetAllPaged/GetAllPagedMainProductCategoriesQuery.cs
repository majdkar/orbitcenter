...
{
    public class GetAllPagedMainProductCategoriesQuery : IRequest<PaginatedResult<GetAllPagedProductCategoriesResponse>>
    {
        ...
        public GetAllPagedMainProductCategoriesQuery(int pageNumber, int pageSize, string searchString, string orderBy)
        {
    ...
    internal class GetAllMainProductCategoriesQueryHandler : IRequestHandler<GetAllPagedMainProductCategoriesQuery, PaginatedResult<GetAllPagedProductCategoriesResponse>>
    {
        private readonly IUnitOfWork<int> _unitOfWork;

        public GetAllMainProductCategoriesQueryHandler(IUnitOfWork<int> unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<PaginatedResult<GetAllPagedProductCategoriesResponse>> Handle(GetAllPagedMainProductCategoriesQuery request, CancellationToken cancellationToken)
        {
            ...
            var productCategoryFilterSpec = new MainProductCategoryFilterSpecification(request.SearchString);
