...
{
    public class GetAllPagedCourseCategorySonsQuery : IRequest<PaginatedResult<GetAllPagedCourseCategoriesResponse>>
    {
        ...
        public GetAllPagedCourseCategorySonsQuery(int categoryId, int pageNumber, int pageSize, string searchString, string orderBy)
        {
    ...
    internal class GetAllCourseCategorySonsQueryHandler : IRequestHandler<GetAllPagedCourseCategorySonsQuery, PaginatedResult<GetAllPagedCourseCategoriesResponse>>
    {
        private readonly IUnitOfWork<int> _unitOfWork;

        public GetAllCourseCategorySonsQueryHandler(IUnitOfWork<int> unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<PaginatedResult<GetAllPagedCourseCategoriesResponse>> Handle(GetAllPagedCourseCategorySonsQuery request, CancellationToken cancellationToken)
        {
            ...
            var CourseCategoryFilterSpec = new CourseCategoryByParentCategoryFilterSpecification(request.SearchString, request.CategoryId);
