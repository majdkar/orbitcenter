...
{
    public class GetAllPagedMainCourseCategoriesQuery : IRequest<PaginatedResult<GetAllPagedCourseCategoriesResponse>>
    {
        ...
        public GetAllPagedMainCourseCategoriesQuery(int pageNumber, int pageSize, string searchString, string orderBy)
        {
    ...
    internal class GetAllMainCourseCategoriesQueryHandler : IRequestHandler<GetAllPagedMainCourseCategoriesQuery, PaginatedResult<GetAllPagedCourseCategoriesResponse>>
    {
        private readonly IUnitOfWork<int> _unitOfWork;

        public GetAllMainCourseCategoriesQueryHandler(IUnitOfWork<int> unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<PaginatedResult<GetAllPagedCourseCategoriesResponse>> Handle(GetAllPagedMainCourseCategoriesQuery request, CancellationToken cancellationToken)
        {
            ...
            var CourseCategoryFilterSpec = new MainCourseCategoryFilterSpecification(request.SearchString);
