...
{
    public class GetAllPagedCoursesByCategoryIdQuery : IRequest<PaginatedResult<GetAllCoursesResponse>>
    {
        ...
        public GetAllPagedCoursesByCategoryIdQuery(int pageNumber, int pageSize, string searchString, string orderBy,int categoryId)
        {
    ...
    internal class GetAllPagedCoursesByCategoryIdQueryHandler : IRequestHandler<GetAllPagedCoursesByCategoryIdQuery, PaginatedResult<GetAllCoursesResponse>>
    {
        private readonly IUnitOfWork<int> _unitOfWork;

        public GetAllPagedCoursesByCategoryIdQueryHandler(IUnitOfWork<int> unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<PaginatedResult<GetAllCoursesResponse>> Handle(GetAllPagedCoursesByCategoryIdQuery request, CancellationToken cancellationToken)
        {
            ...
            var CourseFilterSpec = new AllCourseByCategoryIdFilterSpecification(request.SearchString,request.CategoryId);
