...
{
    public class GetAllPagedProductsByCategoryIdQuery : IRequest<PaginatedResult<GetAllProductsResponse>>
    {
        ...
        public GetAllPagedProductsByCategoryIdQuery(int pageNumber, int pageSize, string searchString, string orderBy,int categoryId)
        {
    ...
    internal class GetAllPagedProductsByCategoryIdQueryHandler : IRequestHandler<GetAllPagedProductsByCategoryIdQuery, PaginatedResult<GetAllProductsResponse>>
    {
        ...
        public async Task<PaginatedResult<GetAllProductsResponse>> Handle(GetAllPagedProductsByCategoryIdQuery request, CancellationToken cancellationToken)
        {
            ...
            var productFilterSpec = new AllProductByCategoryIdFilterSpecification(request.SearchString,request.CategoryId);
