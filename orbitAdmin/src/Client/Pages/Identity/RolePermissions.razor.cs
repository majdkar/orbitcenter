...
using SchoolV01.Client.Infrastructure.Mappings;
...
namespace SchoolV01.Client.Pages.Identity
{
    public partial class RolePermissions
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            _canSearchRolePermissions = (await _authorizationService.AuthorizeAsync(_currentUser, Permissions.RoleClaims.View)).Succeeded;
        ...
        private async Task SaveAsync()
        {
            ...
            var result = await RoleManager.UpdatepostPermissionsAsync(request);
            if (result.Succeeded)
            {
