...
{
    public partial class ClientCompanies
    {
        ...
        private async Task LoadData(int pageNumber, int pageSize, TableState state)
        {
            ...
            var request = new GetAllPagedCompaniesByTypeRequest { CompanyName = CompanyName, Email = Email, PhoneNumber = PhoneNumber, CountryId = CountryId, PageSize = pageSize, PageNumber = pageNumber + 1, SearchString = _searchString, Orderby = orderings };
            var response = await CompanyManager.GetAllPagedClientCompaniesAsync(request);
        ...
        {
            _navigationManager.NavigateTo($"/company-details/client/{companyId}");
        }
