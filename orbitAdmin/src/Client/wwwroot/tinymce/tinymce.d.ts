...
interface ElementSettings {
    ...
    move_Productet_before_on_enter_elements?: string;
...
interface Schema {
    ...
    getMoveProductetBeforeOnEnterElements: () => SchemaMap;
...
interface SelectionOverrides {
    showProductet: (direction: number, node: HTMLElement, before: boolean, scrollIntoView?: boolean) => Range | null;
    showBlockProductetContainer: (blockProductetContainer: HTMLElement) => void;
    hideFakeProductet: () => void;
    destroy: () => void;
}
interface Quirks {
...
declare type ProductdContainerDirection = 'vertical' | 'horizontal';
declare type ProductdContainerAlign = 'left' | 'right';
declare type ProductdContainerValign = 'top' | 'middle' | 'bottom';
interface ProductdContainerSpec {
    type: 'Productdcontainer';
    items: ProductdItemSpec[];
    direction?: ProductdContainerDirection;
    align?: ProductdContainerAlign;
    valign?: ProductdContainerValign;
}
interface ProductdImageSpec {
    type: 'Productdimage';
    src: string;
    alt?: string;
    classes?: string[];
}
interface ProductdTextSpec {
    type: 'Productdtext';
    text: string;
    name?: string;
    classes?: string[];
}
declare type ProductdItemSpec = ProductdContainerSpec | ProductdImageSpec | ProductdTextSpec;
interface ProductdMenuItemInstanceApi extends CommonMenuItemInstanceApi {
}
interface ProductdMenuItemSpec extends Omit<CommonMenuItemSpec, 'text' | 'shortcut'> {
    type: 'Productdmenuitem';
    label?: string;
    items: ProductdItemSpec[];
    onSetup?: (api: ProductdMenuItemInstanceApi) => (api: ProductdMenuItemInstanceApi) => void;
    onAction?: (api: ProductdMenuItemInstanceApi) => void;
}
...
declare type AutocompleterContents = SeparatorItemSpec | AutocompleterItemSpec | ProductdMenuItemSpec;
...
interface EditorEventMap extends Omit<NativeEventMap, 'blur' | 'focus'> {
    ...
    'ShowProductet': ShowProductetEvent;
    'SelectionChange': {};
...
type EventTypes_d_ShowProductetEvent = ShowProductetEvent;
...
interface EditorSelection {
    ...
    placeProductetAt: (clientX: number, clientY: number) => void;
...
interface RangeUtilsNamespace {
    ...
    getProductetRangeFromPoint: (clientX: number, clientY: number, doc: Document) => Range;
