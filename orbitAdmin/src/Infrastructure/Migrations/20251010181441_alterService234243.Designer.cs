...
namespace SchoolV01.Infrastructure.Migrations
{
    ...
    [Migration("20251010181441_alterService234243")]
    partial class alterService234243
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.Orders.CourseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.Orders.ProductOrderItem", b =>
                {
                    ...
                    b.HasOne("SchoolV01.Domain.Entities.Orders.ProductOrder", "ProductOrder")
                        .WithMany("Items")
