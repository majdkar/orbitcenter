        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyFileUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LicenseIssuingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ResponsiblePersonNameAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResponsiblePersonNameEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentifierImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_Deleted",
                table: "Companies",
                column: "Deleted");

            migrationBuilder.CreateIndex(
                name: "IX_Countries_Deleted",
                table: "Countries",
                column: "Deleted");
