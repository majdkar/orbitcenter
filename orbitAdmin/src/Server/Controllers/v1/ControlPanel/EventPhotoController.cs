...
{
    public class EventPhotoController : ApiControllerBase
    {
        private readonly IEventPhotoService photoService;

        public EventPhotoController(IEventPhotoService photoService)
        {
            this.photoService = photoService;
        }

        [HttpGet("{id:int}")]
        public async Task<ActionResult<EventPhotoViewModel>> Get(int id)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<EventPhotoViewModel>> Create(EventPhotoInsertModel photoInsertModel)
        {
            try
            {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<EventPhotoViewModel>> Update(int id, EventPhotoUpdateModel photoUpdateModel)
        {
            try
            {
        ...
        [HttpDelete("{id:int}")]
        public async Task<ActionResult<EventPhotoViewModel>> Delete(int id)
        {
            try
            {
